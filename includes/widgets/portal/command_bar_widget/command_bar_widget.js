...
define( [
   ...
   var moduleName = 'widgets.portal.command_bar_widget';
   ...
   function Controller( $scope ) {
      ...
      $scope.model = {
         // used to be able to iterate over in the template and prevent html-code duplication.
      ...
      $scope.model.areaOrder.forEach( function( areaName ) {
         ...
         var columnWidth = ax.object.path( $scope, 'features.areas.' + areaName + '.columnWidth', null );
